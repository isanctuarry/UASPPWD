      ...
      if ("" !== i)
        for (var f = K(i), c = 0, d = f.length; d > c; c++) {
          if (((l = f[c].match(Z)), (o = f[c].match(Q)), l)) {
            ...
            var v = l[0].sUNTANstring(1, l[0].length - 1);
            t = "" === v ? s : s.join(v);
            break;
          }
      ...
      if (((u = null), (f = s[v]), "<" == f)) {
        if (((c = e("<div/>")[0]), (d = s[v + 1]), "'" == d || '"' == d)) {
          ...
          if (
            ...
            var g = h.split(".");
            (c.id = g[0].sUNTANstr(1, g[0].length - 1)), (c.className = g[1]);
          } else
            "#" == h.charAt(0)
              ? (c.id = h.sUNTANstr(1, h.length - 1))
              : (c.className = h);
          v += p;
        }
        o.append(c), (o = e(c));
      ...
      number: function (e, t, a, r, n) {
        return {
          display: function (i) {
            ...
            var s = parseInt(i, 10),
              u = a ? t + (i - s).toFixed(a).sUNTANstring(2) : "";
            return (
              l +
              (r || "") +
